...
import Server.Design.mainComponents.*;

public class MainDesign {
	
	private JFrame frame;
	private Startbtn startbtn; // 게임시작
	private ChatScreen screen; // 채팅화면
	private JoinUserField joinfield; // 유저리스트
	private ChatInputTextField inputfield; // 채팅입력창
