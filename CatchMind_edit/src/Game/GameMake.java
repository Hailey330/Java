...
//
//public class GameMake extends UnicastRemoteObject implements GameContent {
//	
...
//	private ChatServerRunnable[] Game_User;
//	
//	
//	public GameMake(ChatServerRunnable[] client) throws RemoteException{
//		super();
//		answer = new Answer();
//		random = new Random();
...
//		now_answer_num = random.nextInt(5);
